...
const data: { [key: string]: SegmentEntry } = {
    "ALC": { requires: 1, elements: ["5463", "C552", "4471", "1227", "C214"] },
    ...
    "UNB": { requires: 5, elements: ["S001", "S002", "S003", "S004", "0020", "S005", "0026", "0029", "0031", "0032", "0035"] },
